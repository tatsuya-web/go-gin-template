...
//			},
//			LoadFunc: func(ctx context.Context, key string) (model.UserID, error) {
//				panic("mock out the Load method")
//			},
//			SaveFunc: func(ctx context.Context, key string, userID model.UserID) error {
...
// Load calls LoadFunc.
func (mock *StoreMock) Load(ctx context.Context, key string) (model.UserID, error) {
...
// Save calls SaveFunc.
func (mock *StoreMock) Save(ctx context.Context, key string, userID model.UserID) error {
